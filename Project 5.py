#Charlie Brown Project 5

"""
Text Analysis Project 5
Title: The Lightning Thief (Chapter 1)
Author: Rick Riordan
Source URL: Obtained via excerpt from Rick Riordan's official site/sample
Word Count: 3392
Reason for Choice: I chose this book/chapter because I used to enjoy reading the Percy Jackson series growing up and I just thought it would be a great passage that
provides a unique dataset for a named entity and word frequency analysis.
"""
...
def load_text():
    """Returns the text of the chapter as a single string."""
    my_text = """
...
The class drifted off, the girls holding their stomachs, the guys
pushing each other around and acting like doo-fuses.
Grover and I were about to follow when Mr. Brunner said, "Mr.
Jackson."
I knew that was coming.
I told Grover to keep going. Then I turned toward Mr. Brunner.
"Sir?"
Mr. Brunner had this look that wouldn't let you go-intense brown
eyes that could've been a thousand years old and had seen
everything.
"You must learn the answer to my question," Mr. Brunner told
me.
"About the titans?"
"About real life. And how your studies apply to it."
"Oh."
"What you learn from me," he said, "is vitally important. I expect
you to treat it as such. I will accept only the best from you, Percy
Jackson."
I wanted to get angry, this guy pushed me so hard.
I mean, sure, it was kind of cool on tournament days, when he
dressed up in a suit of Roman armor and shouted: "What ho!" and
challenged us, sword-point against chalk, to run to the board and
name every Greek and Roman person who had ever lived, and
their mother, and what god they worshipped. But Mr. Brunner
expected me to be as good as everybody else, despite the fact I
have dyslexia and attention deficit disorder and I had never made
above a C- in my life. No-he didn't expect me to be as good; he
expected me to be better. And I just couldn't learn all those names
and facts, much less spell them correctly.
I mumbled something about trying harder, while Mr. Brunner
took one long sad look at the stele, like he'd been at this girl's
funeral.
He told me to go outside and eat my lunch.
The class gathered on the front steps of the museum, where we
could watch the foot traffic along Fifth Avenue.
Overhead, a huge storm was brewing, with clouds blacker than I'd
ever seen over the city. I figured maybe it was global warming or
something, because the weather all across New York state had
been weird since Christmas. We'd had massive snow storms,
flooding, wildfires from lightning strikes. I wouldn't have been
surprised if this was a hurricane blowing in.
Nobody else seemed to notice. Some of the guys were pelting
pigeons with Luncheables crackers. Nancy Bobofit was trying to
pickpocket something out of a lady's purse, and, of course, Mrs.
Dodds wasn't seeing a thing.
Grover and I sat on the edge of the fountain, away from the
others. We thought that maybe if we did that, everybody wouldn't
know we were from that school-the school for loser freaks who
couldn't make it elsewhere.
"Detention?" Grover asked.
"Nah," I said. "Not from Brunner. I just wish he'd lay off me
sometimes. I mean -- I'm not a genius."
Grover didn't say anything for a while. Then, when I thought he
was going to give me some deep philosophical comment to make
me feel better, he said, "Can I have your apple?"
I didn't have much of an appetite, so I let him take it.
I watched the stream of cabs going down Fifth Avenue, and
thought about my mom's apartment, only a little ways uptown
from where we sat. I hadn't seen her since Christmas. I wanted so
bad to jump in a taxi and head home. She'd hug me and be glad to
see me, but she'd be disappointed, too. She'd send me right back
to Yancy, remind me that I had to try harder, even if this was my
sixth school in six years and I was probably going to be kicked
out again. I wouldn't be able to stand that sad look she'd give me. 
Mr. Brunner parked his wheelchair at the base of the handicapped
ramp. He ate celery while he read a paperback novel. A red
umbrella stuck up from the back of his chair, making it look like a
...
I stared at him, stunned. I couldn't believe he was trying to cover
for me. Mrs. Dodds scared Grover to death.
...
I gave her my deluxe I'll-kill-you-later stare. I then turned to face
...
pale, cutting his eyes between me and Mr. Brunner, like he
...
to her, we were back in the Greek and Roman section.
...
"We are not fools, Percy Jackson," Mrs. Dodds said. "It was only
...
Mr. Brunner, who'd been out in front of the museum a minute
...
Grover was sitting by the fountain, a museum map tented over his
head. Nancy Bobofit was still standing there, soaked from her
...
He said, "Who?"
But he paused first, and he wouldn't look at me, so I thought he
was messing with me.
...
He frowned and sat forward, looking mildly concerned. "Percy,
...
def word_tokenization_normalization(text):
    """Cleans and processes text: removes stops, punctuation, and lemmas."""
    doc = nlp(text)
...
def print_top_15_frequent_words(word_counts):
    """Displays the top 15 results."""
    print("--- Top 15 Most Frequent Words ---")
    for word, count in word_counts.most_common(15):
        print(f"{word}: {count}")

def get_top_10_entities(text):
    """
    Identifies and displays the 10 most common Named Entities (People, Places).
    This fulfills the 'Extended Analysis' requirement.
    """
    doc = nlp(text)
    ...
    for ent, count in ent_counts.most_common(10):
        print(f"{ent}: {count}")

def main():
    raw_text = load_text()
    cleaned_words = word_tokenization_normalization(raw_text)
    frequencies = word_count(cleaned_words)
    
    print_top_15_frequent_words(frequencies)
    get_top_10_entities(raw_text)

if __name__ == "__main__":
    main()

"""
PART 3: Word Frequency Analysis (150-200 words)
The top 15 words in the first chapter of 'The Lightning Thief'—including 'Grover', 
'Mr. Brunner', 'Mrs. Dodds', 'look', and 'school'—accurately reflect the 
dual nature of the story's setting. The high frequency of character names 
like 'Grover' and 'Brunner' establishes the social circle of the protagonist, 
while the word 'school' grounds the narrative in a contemporary adolescent 
environment. 

One surprising finding was how often the word 'look' or 'see' appeared, 
highlighting Percy’s role as an observer who is starting to see things 
that others cannot. The word frequencies capture the essence of a 
'Middle Grade' urban fantasy, blending mundane academic life with 
underlying tension. There is a notable absence of 'mythological' words 
in the top 15, which makes sense as the protagonist is still unaware 
of his true heritage at this point in the book.
"""

"""
PART 4: Extended Analysis - Named Entities (75-100 words)
I chose to perform Named Entity Recognition (NER) to identify the people 
and places driving the plot. The analysis successfully identified 
'Yancy Academy,' 'New York,' and 'Museum of Metropolitan Art.' These 
results reveal the specific geographic groundedness of the story. 
Finding 'Mrs. Dodds' and 'Mr. Brunner' as top entities confirms that 
characters are the primary anchors for the reader in this introductory 
chapter. This analysis proves that spaCy can effectively distinguish 
proper nouns to give a 'map' of the story's world.
"""